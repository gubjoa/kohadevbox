...
Vagrant.configure(2) do |config|
  ...
  config.vm.network :forwarded_port, guest: 80,   host: 8006, auto_correct: true  # OPAC
  config.vm.network :forwarded_port, guest: 8080, host: 8606, auto_correct: true  # INTRA
  config.vm.network :forwarded_port, guest: 9200, host: 9206, auto_correct: true  # ES
  config.vm.network "private_network", ip: "192.168.208.16"
  ...
  config.vm.post_up_message = "Welcome to the community-koha box!\nSearch the Internet for details"
