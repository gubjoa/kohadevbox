...
Vagrant.configure(2) do |config|
  ...
  config.vm.network :forwarded_port, guest: 6001, host: 6004, auto_correct: true  # SIP2
  config.vm.network :forwarded_port, guest: 80,   host: 8004, auto_correct: true  # OPAC
  config.vm.network :forwarded_port, guest: 8080, host: 8604, auto_correct: true  # INTRA
  config.vm.network :forwarded_port, guest: 9200, host: 9204, auto_correct: true  # ES
  config.vm.network "private_network", ip: "192.168.208.14"
